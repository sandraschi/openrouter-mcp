...
const BACKEND_NAME: &str = "openrouter-mcp-backend.exe";
const BACKEND_PORT: u16 = 11175;
const BACKEND_TAG: &str = "openrouter-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "OPENROUTER_MCP_PORT";
const ENV_HOST: &str = "OPENROUTER_MCP_HOST";
const ENV_TAURI: &str = "OPENROUTER_MCP_TAURI";
